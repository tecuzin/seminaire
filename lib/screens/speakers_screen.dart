...
class ListViewHSpeakers extends StatelessWidget {
  ...
  final subtitles = [
    ...
    "",
    "Quality Manager\nJ'accompagne les équipes pour leur pzermettre de gagner en maturité sur les sujets des tests et de la qualité en apportant bonnes pratiques, outils et retours d'expérience",
    "",
